...
export const generateRecipe = async (ingredientsArray) => {
    try {
        const response = await fetch("https://cloud-cp-71aq.onrender.com/llm/generate-recipe", {
            method: "POST",
            headers: {
...
export const saveGeneratedRecipe = async (recipeObject) => {
    try {
        ...
        const response = await fetch("https://cloud-cp-71aq.onrender.com/save_recipe", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
...
export const getSavedRecipes = async () => {
    try {
        ...
        const response = await fetch("https://cloud-cp-71aq.onrender.com/get_saved_recipes", {
            headers: {
                Authorization: `Bearer ${token}`
            }
        });
...
export const deleteSavedRecipe = async (id) => {
    try {
        ...
        const response = await fetch(`https://cloud-cp-71aq.onrender.com/delete_recipe/${id}`, {
            method: "DELETE",
            headers: {
                Authorization: `Bearer ${token}`,
            },
